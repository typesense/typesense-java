...
public class SearchParameters   {
  ...
  **/
  private List<String> queryBy = new ArrayList<String>();
  
  @Schema(required = true, description = "The relative weight to give each `query_by` field when ranking results. This can be used to boost fields in priority, when looking for matches. Multiple fields are separated with a comma.")
 /**
  ...
  **/
  private List<String> queryByWeights = new ArrayList<String>();
  ...
  **/
  ...
  @Schema(required = true, description = "Boolean field to indicate that the last word in the query should be treated as a prefix, and not as a whole word. This is used for building autocomplete and instant search interfaces. Defaults to true.")
 /**
  ...
  **/
  private List<Boolean> prefix = new ArrayList<Boolean>();
  ...
  **/
  ...
  @Schema(required = true, description = "You can aggregate search results into groups or buckets by specify one or more `group_by` fields. Separate multiple fields with a comma. To group on a particular field, it must be a faceted field.")
 /**
  ...
  **/
  ...
  @Schema(required = true, description = "List of fields which should be highlighted fully without snippeting")
 /**
   * List of fields which should be highlighted fully without snippeting  
  **/
  private List<String> highlightFullFields = new ArrayList<String>();
  ...
  **/
  ...
  @Schema(required = true, description = "A list of records to unconditionally include in the search results at specific positions. An example use case would be to feature or promote certain items on the top of search results. A list of `record_id:hit_position`. Eg: to include a record with ID 123 at Position 1 and another record with ID 456 at Position 5, you'd specify `123:1,456:5`. You could also use the Overrides feature to override search results based on rules. Overrides are applied first, followed by `pinned_hits` and  finally `hidden_hits`. ")
 /**
   * A list of records to unconditionally include in the search results at specific positions. An example use case would be to feature or promote certain items on the top of search results. A list of `record_id:hit_position`. Eg: to include a record with ID 123 at Position 1 and another record with ID 456 at Position 5, you'd specify `123:1,456:5`. You could also use the Overrides feature to override search results based on rules. Overrides are applied first, followed by `pinned_hits` and  finally `hidden_hits`.   
  **/
  private List<String> pinnedHits = new ArrayList<String>();
  
  @Schema(required = true, description = "A list of records to unconditionally hide from search results. A list of `record_id`s to hide. Eg: to hide records with IDs 123 and 456, you'd specify `123,456`. You could also use the Overrides feature to override search results based on rules. Overrides are applied first, followed by `pinned_hits` and finally `hidden_hits`. ")
 /**
  ...
  **/
  private List<String> hiddenHits = new ArrayList<String>();
